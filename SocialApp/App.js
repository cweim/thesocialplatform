  ...
  useEffect(() => {
    const runAllTests = async () => {
      try {
        ...
        setTestResults(prev => ({
          ...prev,
          firebase: firebaseResult ? '✅ Firebase Connected!' : '❌ Firebase Connection Failed'
        }));
        ...
        setTestResults(prev => ({
          ...prev,
          auth: authResult ? '✅ Authentication System Working!' : '❌ Authentication System Failed'
        }));
        ...
        setTestResults(prev => ({
          ...prev,
          imageUpload: imageResult ? '✅ Image Upload Working!' : '❌ Image Upload Failed'
        }));
        ...
        setTestResults(prev => ({
          ...prev,
          postsSystem: postsResult ? '✅ Posts System Working!' : '❌ Posts System Failed'
        }));
